class SongModel {
  ...
  factory SongModel.fromOfficialJson(Map<String, dynamic> json, {String decryptedUrl = ''}) {
    ...
    return SongModel(
      ...
      downloadUrl: getDownloadUrl(json['downloadUrl'] ?? json['download_url'] ?? moreInfo['downloadUrl'] ?? moreInfo['download_url']),
      hasLyrics: moreInfo['has_lyrics'] == 'true' || json['hasLyrics'] == true || moreInfo['lyrics_id'] != null,
